<div class="card">
    <div class="card-header">
        <a href="<?= base_url('user/tambah') ?>" class="btn btn-primary btn-sm">Tambah <i class="fas fa-plus"></i></a>
    </div>
    <!-- /.card-header -->
    <div class="card-body">
                        ...
                        <div class="card-body">
                            ...
                            <div class="form-group">
                                ...
                                <select class="form-control" name="sts">
                                    <option value="1"> <?php if ($usr->status == 0) : ?>
                            ...
                            <div class="form-group">
                                ...
                                <select class="form-control" name="role">
                                    <option value="admin"><?= $usr->role ?></option>
